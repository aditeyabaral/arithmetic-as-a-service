...
def getLogging(*vargs):
    ...
    result_list = list(map(lambda x: f"{x.time} UTC&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;{x.site}", result))
    result_list.insert(0, "Timestamp&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;| Site")
